...
public class AgendaEventos {
    ...
    public void obterProximoEvento(){
        ...
        for(Map.Entry<LocalDate, Evento> entry : eventosTreeMap.entrySet()){
            if(entry.getKey().isEqual(dataAtual) || entry.getKey().isAfter(dataAtual)){
                ...
                System.out.println("O próxumo evento: " + proximoEvento + " acontecerá na data " + proximaData);
                break;
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.MAY, 19), "Evento 4", "Atração 4");
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.MAY, 20), "Evento 5", "Atração 5");
